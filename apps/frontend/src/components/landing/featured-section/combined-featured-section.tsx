...
export default function CombinedFeaturedSection() {
    const featuredCasestudy = {
        logo: '/api-translator-logo.png',
        company: 'Universal API Translator',
        tags: 'API Translation',
        title: 'Convert APIs seamlessly',
        subtitle: 'Transform between OpenAPI, GraphQL, SOAP, and gRPC with AI-powered intelligence',
    }
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 md:grid-rows-2">
                ...
                <div className="relative rounded-none overflow-hidden bg-muted border border-gray-200 dark:border-gray-800 p-4">
                    ...
                    <h3 className="text-xl font-normal text-gray-900 dark:text-white">
                        Global API translation usage.{" "}
                        <span className="text-gray-500 dark:text-gray-400">Track conversions across regions in real-time.</span>
                    </h3>
                ...
                <div className="rounded-none border border-gray-200 dark:border-gray-800 bg-muted p-6 space-y-4">
                    <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
                        ...
                        Universal API Translator Analytics
                    </div>
                    <h3 className="text-xl font-normal text-gray-900 dark:text-white">
                        Real-time performance tracking for Universal API Translator.{" "}
                        <span className="text-gray-500 dark:text-gray-400">Optimize your API translations instantly.</span>
                    </h3>
                    <MonitoringChart />
                </div>
                ...
                <div className="grid sm:grid-cols-2 rounded-none bg-card">
                    <FeatureCard
                        ...
                        description="Convert between OpenAPI, GraphQL, SOAP, and gRPC seamlessly."
                    />
                    <FeatureCard
                        ...
                        description="Automatically generate client SDKs in multiple languages."
                    />
                </div>
            </div>
        </section>
...
const chartConfig = {
    desktop: {
        label: 'API Conversions (Web)',
        color: '#2563eb', // Primary Blue
    },
    mobile: {
        label: 'API Conversions (Mobile)',
...
const messages: Message[] = [
    {
        ...
        time: "1m ago",
        content: "Successfully converted OpenAPI spec to GraphQL schema.",
        color: "from-pink-400 to-indigo-500",
    },
    {
        title: "SDK Generated",
        time: "3m ago",
        content: "TypeScript SDK generated from your API specification.",
        color: "from-orange-500 to-pink-500",
    },
    {
        title: "Validation Complete",
        time: "6m ago",
        content: "API specification validated successfully.",
        color: "from-yellow-400 to-red-400",
    },
    {
        title: "gRPC Translation",
        time: "10m ago",
        content: "REST API converted to gRPC protocol buffers.",
        color: "from-sky-400 to-blue-700",
    },
    {
        title: "SOAP Migration",
        time: "12m ago",
        content: "Legacy SOAP service migrated to modern REST API.",
        color: "from-orange-300 to-fuchsia-500",
    },
    {
        title: "Batch Processing",
        time: "15m ago",
        content: "50 API endpoints converted in batch operation.",
